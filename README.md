...
| :--- | :--- | :--- | :--- |
| **Pollnow** | Fundador, crea eventos digitales de formato gala. | React TS, Next.js, Tailwind CSS, Prisma, PostgreSQL | [**Repo**](https://github.com/rayelus5/pollnow) - [**Visitar**](https://pollnow.es) |
| **Chaotic Loom** | Creador y diseñador del Frontend de la web | React TS, Next.js, Tailwind CSS, Rust, PostgreSQL | [**Visitar**](https://chaotic-loom.com) |
